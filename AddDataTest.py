...
if  __name__ == '__main__':
    ...
    EventsPortal.addDataToSolrFromUrl("http://bioevents-portal.org/eventsfull/test?state=published&field_type_tid=", "http://bioevents-portal.org/events","localhost:8983/solr/event_portal")
